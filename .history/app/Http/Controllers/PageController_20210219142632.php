...
class PageController extends Controller
{
    ...
    {
        if(Auth::check()) {
            if(Auth::user()->level != 'admin' && Auth::user()->level != 'petugas' && Auth::user()->level == null) {
                return redirect()->route('home')->with('success', 'Anda berhasil masuk sebagai '. Auth::user()->level);
            } else {
                return redirect()->route($path)->with('success', 'Anda berhasil masuk sebagai '. Auth::user()->level);
            }
        } else {
