                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Your name here" aria-describedby="name-feedback">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" required id="name" class="form-control" placeholder="Your email here" aria-describedby="name-feedback">
                            <small id="name-feedback" class="text-muted">required</small>
                        </div>
                    </div>
                </div>
