    ...
    <div class="navbar-fixed position-fixed">
        <div class="container pt-5 mt-5">
            <div class="row py-5">
                ...
                <div class="col-md-6 p-md-5 p-4 text-right position-relative">
                    <img src="{{ asset('img/illust/navbar.png') }}" alt="Navbar Illust" class="position-absolute w-50" style="bottom: 0; left: -10%">
