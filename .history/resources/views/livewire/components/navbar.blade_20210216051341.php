            ...
            <div class="row pt-5 pb-5">
                ...
                <div class="col-md-6 p-md-5 p-4 text-right">
                    ...
                    <div class="px-5 position-relative">
                        <h1 onclick="window.location = '{{ route('home') }}'" class="menu-navbar my-3 d-block viga position-relative">
                            <span class="menu-title">Beranda</span>
                            <span class="icon">
                                <i class="fas fa-arrow-left"></i>
                            </span>
                        </h1>
                        <h1 onclick="window.location = '{{ route('products') }}'" class="menu-navbar my-3 d-block viga position-relative">
