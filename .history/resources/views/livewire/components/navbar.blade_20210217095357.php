    ...
    <div class="navbar-fixed hide position-fixed">
        <div class="container pt-5 mt-5">
            <div class="row pt-5 pb-5">
                ...
                <div class="col-md-6 {{ Auth::check() ? 'px-md-5 py-md-2' : 'p-md-5' }} p-4 text-right">
                    ...
                    <div class="px-5 position-relative">
                        ...
                        <div class="shadow-smooth d-inline-block p-3 card-profile-navbar">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae corrupti praesentium quo ut eveniet quis repudiandae aliquam. Delectus, labore provident. Velit ea quam impedit alias laborum soluta eaque dicta fugiat.
                        </div>
                    </div>
                </div>
            </div>
