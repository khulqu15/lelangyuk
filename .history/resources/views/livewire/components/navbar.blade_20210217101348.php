        ...
        <div class="row w-100">
            ...
            <div class="col-6 px-5 text-right">
                ...
                <div class="avatar-sm-navbar" onclick="window.location = '{{ route("profile") }}'">
                    <div class="image">
                        <img class="image-fit-card" src="{{ asset('img/user/valen.png') }}" alt="">
                    </div>
                </div>
                @endif
            ...
            <div class="row pt-5 pb-5">
                ...
                <div class="col-md-6 maxm-height {{ Auth::check() ? 'px-md-5 py-md-2' : 'p-md-5' }} p-4 text-right">
                    ...
                    <div class="px-5 position-relative">
                        ...
                        <h1 class="{{ Request::is('contact') ? 'active' : '' }} menu-navbar my-3 d-block viga position-relative">
                        ...
                        class="shadow-smooth cursor-point text-left d-inline-block px-4 pt-3 pb-2 card-profile-navbar position-relative" style="right: -5px">
                            <div class="avatar-sm position-relative" style="right: 10px">
                                <img src="{{ asset('img/user/valen.png') }}" class="image-fit-card" alt="{{ Auth::user()->name }}">
                            </div>
                        ...
                        <div class="position-relative" style="right: -10px">
                            <button onclick="window.location = '{{ route('login') }}'" class="btnm-primary px-5">Masuk</button>
                            <button onclick="window.location = '{{ route('register') }}'" class="btnm-light px-5 mx-2">Daftar</button>
                        </div>
                        @endif
                    </div>
                </div>
