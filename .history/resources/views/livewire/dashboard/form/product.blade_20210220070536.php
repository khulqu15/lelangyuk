            ...
            <div class="col-md-12 py-4">
                ...
                <form action="{{ route('storeProduct') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $method == 'edit' ?  \Carbon\Carbon::parse($product->close)->format('mm\dd\yyyy')) : '' }}" required type="date" class="form-control" name="close" id="close" aria-describedby="close-feedback">
