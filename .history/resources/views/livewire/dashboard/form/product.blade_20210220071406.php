            ...
            <div class="col-md-12 py-4">
                ...
                <form action="{{ route('storeProduct') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $method == 'edit' ?  date('mm/dd/yy', strtotime($product->close)) : '' }}" required type="date" class="form-control" name="close" id="close" aria-describedby="close-feedback">
                        <small id="close-feedback" class="form-text text-muted">Required</small>
                    </div>
                    {{date('m/d/yy', strtotime($product->close))}}
                    {{-- {{ Carbon\Carbon::parse($product->close) }} --}}
                    <div class="form-group">
