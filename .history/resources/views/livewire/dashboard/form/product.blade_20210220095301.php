    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 py-4">
                ...
                @endif
                {{ $method }}
                <form action="{{ $method == 'edit' ? route('editProduct', ['id' => $product->id]) : route('storeProduct') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control" name="picture" id="file" accept=".jpg, .png, .jpeg" required="{{ $method == 'edit' ? 'false' : 'true'}}">
                        </div>
