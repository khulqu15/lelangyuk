                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn {{ $product->status == null && $product->status == 'noaktif' ? 'btn-light' ? 'fa-primary' }} btn-sm my-2 p-2">
                                <i class="fas {{ $product->status == null && $product->status == 'noaktif' ? 'fa-eye-slash' ? 'fa-eye' }}"></i>
                            </button>
                            @endif
