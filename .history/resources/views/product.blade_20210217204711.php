...
@section('content')
    ...
    <div class="alert alert-success alert-dismissible position-fixed fade" style="top: 20%">
        <ul>
            <li>{{ \Session::get('success') }}</li>
        </ul>
    </div>
    @else
    <div class="alert alert-danger alert-dismissible position-fixed fade" style="top: 20%">
        <ul>
