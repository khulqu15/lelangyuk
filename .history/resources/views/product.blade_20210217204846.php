...
@section('content')
    ...
    <div class="alert alert-success alert-dismissible position-fixed alert-respond fade">
        <ul>
            <li>{{ \Session::get('success') }}</li>
        </ul>
    </div>
    @else
    <div class="alert alert-danger alert-dismissible position-fixed alert-respond fade">
        <ul>
