...
@section('content')
    ...
    <div role="aler" class="alert alert-success alert-dismissible show position-fixed alert-respond fade">
        <ul class="mb-0 pb-0">
    ...
    <div role="aler" class="alert alert-danger alert-dismissible show position-fixed alert-respond fade">
        <ul>
