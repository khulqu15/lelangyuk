    ...
    <div class="container-fluid pt-5 pb-4">
        <div class="container pt-5">
            <div class="row pt-5">
                ...
                <div class="col-md-8">
                    <button class="btn viga btnm-primary" onclick="toggleView('product')">Produk yang disukai</button>
                    <button class="btn viga btnm-light mx-2" onclick="toggleView('auction')">Catatan Lelang</button>
                    <div class="row mt-3">
