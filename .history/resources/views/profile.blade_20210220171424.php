        ...
        <div class="modal-dialog modal-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="change-data" class="d-none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 text-center pt-4">
                                    <div class="avatar-sm d-inline-block">
                                        <img class="image-fit-card" src="{{ Auth::user()-> == null ? asset('img/user/avatar.png') : asset('img/user/'.Auth::user()->avatar) }}" id="preview-image" alt="{{ Auth::user()->name }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group my-2">
                    ...
                    <div id="change-password">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam qui quibusdam earum quia molestias consequuntur eum obcaecati minus ducimus maxime, modi eaque eius corrupti sit architecto mollitia accusantium neque amet.
                    </div>
                    <script>
                        $('#data-toggle').click(function() {
                            $(this).addClass('btnm-primary').removeClass('btnm-light')
                            $('.password-toggle').addClass('btnm-primary').removeClass('btnm-light')
                            $('#change-data').removeClass('d-none')
                            $('#change-password').addClass('d-none')
                        })
                        $('#password-toggle').click(function() {
                            $(this).addClass('btnm-primary').removeClass('btnm-light')
                            $('.data-toggle').addClass('btnm-primary').removeClass('btnm-light')
                ...
                <div class="col-md-4">
                    <div class="card position-sticky sticky-top border-0 mb-4 shadow-smooth text-center shadow px-4 pt-5 pb-3 position-relative"
                        ...
                        <div class="avatar-profile mt-3">
                            <img src="{{ Auth::user()-> == null ? asset('img/user/avatar.png') : asset('img/user/'.Auth::user()->) }}" class="image-fit-card rad" alt="{{ Auth::user()->name }}">
                        </div>
