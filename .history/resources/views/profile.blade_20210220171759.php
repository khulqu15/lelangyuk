                ...
                <div class="modal-body">
                    ...
                    <div id="change-password">
                        <div class="form-group my-2">
                            ...
                            <input type="text" required name="old_password" id="old_password" class="form-control">
                        </div>
                        <div class="form-group my-2">
                            <label for="new_password">Password Baru</label>
                            <input type="text" required name="new_password" id="new_password" class="form-control">
                        </div>
                        <div class="form-group my-2">
