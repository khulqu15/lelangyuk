...
<div class="container-fluid mt-5 py-5 ng-light">
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <button class="btn btnm-primary mx-2 px-4 py-2">Semua</button>
                <button class="btn btnm-light mx-2 px-4 py-2">Elektronik</button>
                <button class="btn btnm-light mx-2 px-4 py-2">Komponen</button>
            </div>
        </div>
    </div>
</div>
