            ...
            <div class="col-md-4 col-sm-6 my-2">
                <div class="card card-product border-0 cursor-point mb-4">
                    ...
                    <div class="body p-4">
                        ...
                        <button class="btn btnm-primary py-3 px-5 position-absolute" style="right:0; bottom: -16px">Lebih Detail</button>
                    </div>
                </div>
            </div>
            @endforeach
            <div class="col-12 text-center py-4">
                <button class="btn btnm-primary px-5 py-3 voga">Lihat Semua Produk</button>
            </div>
        </div>
    </div>
</div>
