...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'multi.auth']], function() {
    Route::get('/dashboard', [PageController::class, 'dashboard'])->name('dashboard');
    Route::get('/dashboard-product', [PageController::class, 'productDashboard'])->name('dashboard.product');
});
